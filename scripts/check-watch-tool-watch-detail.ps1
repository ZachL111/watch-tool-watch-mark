...
$repo = "watch-tool-watch-mark"
$language = "Python"
$category = "CLI tools"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/watch-tool-watch-walkthrough.md")) {
