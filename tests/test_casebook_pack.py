"""Regression checks for the watch-tool-watch-mark casebook."""
...
from casebook.harness import assert_expected, watch_tool_watch_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_tool_watch_mark_summary(), assert_expected())
