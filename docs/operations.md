...
`watch-tool-watch-mark` is centered on cli tools work in Python. The technical target is: Package a Python local lab for watch analysis with fixture event logs, golden state snapshots, and documented operating limits.
...
The score is deterministic. The current threshold is 183. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 2.
